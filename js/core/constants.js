...
export const ENERGY_ICONS = Object.freeze({
...
export const STATUS_TYPES = new Set(['poison', 'poisoned', 'paralysis', 'paralyzed', 'sleep', 'asleep', 'burn', 'burned', 'confusion', 'confused']);

export const ABILITY_BADGE = 'https://archives.bulbagarden.net/media/upload/thumb/0/06/TCGAbilityIcon.png/150px-TCGAbilityIcon.png';

export const STATUS_ICON_URLS = {
